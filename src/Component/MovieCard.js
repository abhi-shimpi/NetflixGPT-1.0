            ...
            <div className='container-card' >
              ...
              <div className='p-5 card-with-movie bg-black'>
                ...
                <div className='flex gap-8 py-3 items-center text-white'>
                  ...
                  {
                    showAddTo ?
                      (<div className='pl-[72px] text-sm flex gap-2 items-center cursor-pointer'>
                        <span>Add To</span>
                        <div className='w-5 h-5'><img className='w-full h-full' src={add_btn} alt='addButtonImage' onClick={(e) => {
                          addToFavourite();
                        }}></img></div>
                      </div>)
                      :
